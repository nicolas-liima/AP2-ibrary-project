...
public class Livro {
    ...
    public Livro(int id, String titulo, String autor, String categoria, int quantidadeEstoque, String isbn) {
        this.id = id;
        this.titulo = titulo;
        this.autor = autor;
    ...
    // Construtor sem ID
    public Livro(String titulo, String autor, String categoria, int quantidadeEstoque, String isbn) {
        this.titulo = titulo;
        this.autor = autor;
        this.categoria = categoria;
        this.quantidadeEstoque = quantidadeEstoque;
